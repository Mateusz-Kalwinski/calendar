...
<div class="container">
    <form class="form-login z-depth-5" action="assets/inc/process.inc.php" method="post" autocomplete="off">
        <div class="input-field">
            <i class="material-icons prefix indigo-text text-lighten-2">account_circle</i>
